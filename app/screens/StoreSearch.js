        ...
        <ImageBackground source={require('./../assets/bg.png')} resizeMode="cover" style={{ flex:1, justifyContent:'center'}}>
            ...
            <InnerContainer>
                <DashboardContainer>
                    ...
                    />
                    <PageTitle dashbaord={true}>Do you want to find a hardware store?</PageTitle>
                    <StyledFormArea>
                        <MyTextInput
                            searchMaterial={true}
                            icon="search" 
                        ...
                        />
                        <StyledButton btnSearch={true} onPress={() => {navigation.navigate('MaterialSearchMapScreen', {searchText, mapRegion, type: 'store', sData: {}, prodData: {}})}}>
